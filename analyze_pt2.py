...
class ArxivAnalyzer:
    ...
    def plot_results(self, df: pd.DataFrame, output_dir: str = "plot2"):
        """Create bar plots of the results with error bars."""
        ...
        plt.tight_layout()
        plt.savefig(output_dir / 'average_score.png', dpi=300, bbox_inches='tight')
        plt.close()
        ...
        plt.xticks(rotation=45, ha='right')
        plt.tight_layout()
        plt.savefig(output_dir / 'ai_percentage.png', dpi=300, bbox_inches='tight')
        plt.close()
